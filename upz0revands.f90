...
!              for Vandsteelandt et al. (2000), with constant Se/Sp				!
!                          Date: August 05, 2015								!
!*******************************************************************************!
      subroutine upz0revands(pz0,pj,Sp,cj,SeI)
      implicit none
      integer cj
...
65       continue
         ...
         pz0 = prb(1)*Sp
         do 70 s = 2, (cj+1)
		    pz0 = pz0 + prb(s)*(1.0-SeI)
70       continue

      return
      end   ! Needs to double-check
