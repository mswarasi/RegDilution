...
beta0 <- optim(beta.t,Dorfman.const.loglik,Z=Z,Y=Y,X=X,cvec=c.vec,Sp=Sp.t,Se=Se.t,J=J,id=id)$par
...
## Results from the constant Se model with Dorfman testing in Zhang, Bilder, and Tebbs (2013)
